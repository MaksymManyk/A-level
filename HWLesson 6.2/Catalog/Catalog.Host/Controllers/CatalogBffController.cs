...
public class CatalogBffController : ControllerBase
{
    ...
    [HttpPost("{brandID}")]
    [ProducesResponseType(typeof(PaginatedItemsResponse<CatalogItemDto>), (int)HttpStatusCode.OK)]
    public async Task<IActionResult> GetByBrand(int brandID, PaginatedItemsRequest request)
    {
    ...
    [HttpPost("{typeID}")]
    [ProducesResponseType(typeof(PaginatedItemsResponse<CatalogItemDto>), (int)HttpStatusCode.OK)]
    public async Task<IActionResult> GetByType(int typeID, PaginatedItemsRequest request)
    {
